      ...
      <div className="relative container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Advanced management solutions tailored for specific industries, each optimized for unique operational requirements and{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <ServiceCard
            ...
            title="Healthcare Matrix"
            details="Comprehensive healthcare solution with AI-powered diagnostics, quantum patient records management, telemedicine integration, and neural HIPAA compliance."
            icon={
              <svg
            ...
            tech={["Neural Diagnostics", "Quantum Telemedicine", "HIPAA Compliant"]}
          />

          {/* Hotel Management */}
          <ServiceCard
            link="/services/hotel"
            title="Hospitality Neural Network"
            details="Smart hospitality platform with IoT integration, automated quantum check-in/out, dynamic AI pricing, and holographic guest experience optimization."
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="text-purple-400 animate-neon-flicker" viewBox="0 0 64 64">
            ...
            tech={["Quantum IoT", "Neural Rooms", "AI Pricing"]}
          />

          {/* Fleet Management */}
          <ServiceCard
            link="/services/car"
            title="Fleet Quantum Control"
            details="Advanced fleet operations with quantum GPS tracking, predictive neural maintenance, autonomous vehicle support, and carbon-neutral monitoring."
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="48"
                height="48"
                fill="currentColor"
                className="text-green-400 animate-neon-flicker"
                viewBox="0 0 16 16"
              >
            ...
            tech={["Quantum GPS", "Neural AI", "Carbon Neutral"]}
          />

          {/* Restaurant Operations */}
          <ServiceCard
            link="/services/restaurant"
            title="Culinary Neural System"
            details="Complete restaurant ecosystem with AI menu optimization, quantum kitchen automation, holographic ordering, and neural supply chain integration."
            icon={
              <svg
                width="48"
                height="48"
                viewBox="0 0 122.88 115.21"
                className="text-orange-400 animate-neon-flicker"
                fill="currentColor"
              >
            ...
            tech={["Neural Menu", "Quantum Kitchen", "Holographic UI"]}
          />

          {/* Inventory Control */}
          <ServiceCard
            link="/services/stock"
            title="Quantum Inventory Matrix"
            details="Intelligent inventory management with blockchain tracking, neural demand forecasting, automated quantum reordering, and multi-dimensional warehouse optimization."
            icon={
              <svg
                fill="currentColor"
                height="48"
                width="48"
                viewBox="0 0 512 512"
                className="text-indigo-400 animate-neon-flicker"
              >
            ...
            tech={["Quantum Blockchain", "Neural Forecasting", "Multi-Dimensional"]}
          />

          {/* Custom Solutions */}
          <ServiceCard
            link="/services/CustomWebApp"
            title="Quantum Custom Solutions"
            details="Bespoke enterprise applications with quantum microservices architecture, neural API-first design, and multi-dimensional cloud-native deployment strategies."
            icon={
              <svg
                width="48"
                height="48"
                viewBox="0 0 122.88 113.37"
                className="text-teal-400 animate-neon-flicker"
                fill="currentColor"
              >
            ...
            tech={["Quantum Microservices", "Neural API", "Multi-Dimensional"]}
          />
        </div>
      </div>
    </section>
      ...
      <div className="relative p-8">
        <Link href={link} className="block">
          ...
          <div className="mb-6 relative">
            <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${gradient} p-0.5 neural-border`}>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {tech.map((item, index) => (
              <span key={index} className="px-3 py-1 glass-card text-xs text-gray-300 rounded-full border border-cyan-400/20 text-mono group-hover:border-cyan-400/40 transition-colors duration-300">
                {item}
              </span>
            ))}
          </div>
